...
const Footer = () => {
  return (
    <div className="w-full h-[40vh] flex justify-around items-center bg-yellow-800 max-[900px]:flex-col max-[1150px]:h-auto">
      <div>
        <h1 className={`text-5xl max-[1150px]:text-4xl max-[700px]:text-5xl max-[900px]:text-6xl max-[560px]:text-4xl max-[900px]:m-7 ${headerfont.className} font-bold text-yellow-950`}>
      ...
      <div className="flex flex-col max-[900px]:m-5">
        ...
        <div className="flex items-center">
          ...
          <p className="text-2xl max-[1150px]:text-[1.3rem] text-yellow-400 max-[700px]:text-[1.2rem] max-[900px]:text-[1.5rem] max-[560px]:text-[1rem] max-[560px]:m-0 m-2 font-sans font-bold">areebixpoint.vercel.app</p>
        </div>
        ...
        <div className="flex items-center">
          ...
          <p className="text-2xl max-[1150px]:text-[1.3rem] text-yellow-400 max-[700px]:text-[1.2rem] max-[900px]:text-[1.5rem] max-[560px]:text-[1rem] max-[560px]:m-0 m-2 font-sans font-bold">03709180147</p>
        </div>
      </div>
