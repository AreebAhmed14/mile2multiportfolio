...
const Skills = () => {
  return (
    <div id='skills' className='w-full flex bg-yellow-800 justify-center border-b-[0.5rem] border-b-amber-200 items-center flex-col'>
      ...
      <div className='w-[75%]'>
      <h1 className='mt-4 text-4xl font-bold font-sans text-white max-[650px]:text-3xl max-[400px]:text-2xl max-[400px]:mt-2'>AENTIC AI</h1>
      </div>
      ...
      <div className='w-[75%]'>
      <h1 className='mt-4 text-4xl font-bold font-sans text-white max-[650px]:text-3xl max-[400px]:text-2xl max-[400px]:mt-2'>PYTHON</h1>
      </div>
      <div className='w-[80%] h-[10vh] m-4 bg-gray-400 overflow-hidden border-[0.5rem] max-[850px]:border-[0.6rem] max-[450px]:h-[4rem] max-[450px]:w-[85%] border-gray-400 rounded-[3rem]'>
      ...
      <div className='w-[75%]'>
      <h1 className='mt-4 text-4xl font-bold font-sans text-white max-[650px]:text-3xl max-[400px]:text-2xl max-[400px]:mt-2'>WEB DEV</h1>
      </div>
      <div className='w-[80%] h-[10vh] m-4 bg-gray-400 overflow-hidden border-[0.5rem] max-[850px]:border-[0.6rem] max-[450px]:h-[4rem] max-[450px]:w-[85%] border-gray-400 rounded-[3rem]'>
